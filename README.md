...
------------------------------
The results that are generated by SSTAR are shown in the graphical interface as explained in the previous section, however SSTAR is also producing several other files in the same folder as your input data:

1.	Three BLASTN database files, created from your genome assembly input file, with extensions .nin, .nhr and .nsq
2.	A plain text file called ‘BLASTN’. This file contains the raw BLASTN results, including results that didn’t make it to the SSTAR graphical interface. 
